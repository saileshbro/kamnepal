    ...
    <div class="containerProfile">
      <div class="profileUpdate">
        ...
        while ($row = mysqli_fetch_assoc($res)) {
          ...
          <a href='javascript:;' onclick='removeEduPressed(this.id);' class='links remedu' id='edu-" . $row['id'] . " >Remove</a>
          </div>";
        }
        ?>
        </div>
        ...
        while ($row = mysqli_fetch_array($res)) {
          ...
          <textarea name='emp-detail-" . $row['id'] . "' cols='30' rows='10' placeholder='Explain your role'>" . $row['emp_details'] . "</textarea>
          <a href='javascript:;' onclick='removeExpPressed(this.id);' class='links remexp' id='emp-" . $row['id'] . "' >Remove</a></div>";
        }
        ?>
        </div>
        </div>
        ...
        $res = mysqli_query($con, $sql);
        while ($row = mysqli_fetch_array($res)) {
          echo "<div id='skill-set'><div class='skillinp skills-" . $row['id'] . "'><div class='inpgrp'>
          <input class='skills' name='skill-type-" . $row['id'] . "' value='" . $row['skill_type'] . "'class='input1' placeholder='Add skill type. Eg. Language'>
          <input class='skills' name='skill-list-" . $row['id'] . "' value='" . $row['skill_list'] . "'class='input1' placeholder='Add skills. Eg. English, French, Spanish'>
          </div>
          <a href='javascript:;' onclick='removeSkillPressed(this.id);' class='links remexp' id='emp-" . $row['id'] . "' >Remove</a></div></div>";
        }
        ?>
        </div>
