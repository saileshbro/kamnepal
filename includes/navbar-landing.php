...
<nav class="navbar-landing" id='#navbar-landing'>
  <div class="navbar-left">
    <div class="navbar-links">
      <ul>
        <li><a class='links' href="../register/jobseeker.php">Find a job</a></li>
        <li><a class='links' href="../register/employer.php">Post a job</a></li>
      </ul>
    </div>
  </div>
  <div class="navbar-right">
    <div class="navbar-links">
      <ul>
        ...
        <li>
          <a href="#" id='register' onclick='toggleDropdown()' class="links">Register</a>
          <div class="dropdown">
